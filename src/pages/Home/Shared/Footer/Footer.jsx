const Footer = () => {
  return (
    <footer className="text-neutral-content">
      <div className="grid grid-cols-1 md:grid-cols-2">
        <div className="bg-[#1F2937]  p-10 w-full">
          <div className="lg:pl-48">
            <p className="uppercase text-2xl  text-center mb-4">contact us</p>
        ...
        <div className="bg-[#111827] w-full p-10 ">
          <div className="lg:pr-48">
            ...
            <p className="text-center my-4">Join us on social media</p>
      ...
      <div>
        <footer className="footer footer-center p-2 bg-[#151515] text-white">
          <aside>
            <p>
              Copyright ©{new Date().getFullYear()} CulinaryCloud - All right
              reserved
            </p>
          </aside>
        </footer>
